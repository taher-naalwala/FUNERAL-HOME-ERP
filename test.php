                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="qabar_no" type="number" class="form-control" placeholder="Enter Qabar Number" required>
                                                        </div>
                        ...
                        ?>
                                    <form method="POST">
                                        ...
                                        if (isset($_POST['submit1'])) {
                                            ...
                                            $log = "TRIED TO ADD DAFAN ENTRY FOR " . $name;
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <input type="text" name="imc_date" placeholder="Select IMC Date" autocomplete="FALSE" class="form-control datepicker">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control" name="m_address" maxlength="150" placeholder="Enter Address (150 Characters Only)"></textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                ...
                                                                <input type="text" name="date_of_death" placeholder="Select Date of Death" autocomplete="FALSE" class="form-control datepicker" id="datepicker" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            ...
                                            <?php
                                            $s2 = "SELECT number from qabar_info where amt='$budget' and status=0 and harwai_status=0";
                                            // $run2 = $conn->query($s2);
                                            ...
                                            if ($rows > 0) {
                                                ...
                                                echo '<table id="order-table" class="table table-striped table-bordered nowrap">';
                                            ?>
...
$(document).ready(function(){
    ...
    alert($().jquery); // This prints v3.3.1
    alert($jq().jquery); // This prints v1.4.2
