...
if ($_SESSION['access_qabrastan'] == "1" && $_SESSION['exp_date_qabrastan'] > $c_d) {
    ...
    $flag = 0;
    if (in_array("27", $forms_access) || in_array("23", $forms_access)) {
    } else {
...
<body>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                if (isset($_POST['submit1'])) {
                                    $receipt_number = $_POST['submit1'];
                                    $amt = $_POST['amt'];
                                    $receipt_status = $_POST['receipt_status'];
                                    $receipt_date = $_POST['receipt_date'];
                                    $new_receipt_number = $_POST['receipt_no'];
                                    $pay_mode = $_POST['mode'];
                                    $cn = $_POST['cn'];
                                    ...
                                    if ($receipt_type == "NW") {
                                        if ($pay_mode == 0) {
                                            $sql = "UPDATE  dafan_receipt_1 set amt='$amt',status=$receipt_status,date='$receipt_date',id=$new_receipt_number,pay_mode=$pay_mode,cn='' where id=$receipt_number";
                                        } else {
                                            $sql = "UPDATE  dafan_receipt_1 set amt='$amt',status=$receipt_status,date='$receipt_date',id=$new_receipt_number,pay_mode=$pay_mode,cn='$cn' where id=$receipt_number";
                                        }
                                    } else {
                                        if ($pay_mode == 0) {
                                            $sql = "UPDATE  dafan_receipt set amt='$amt',status=$receipt_status,date='$receipt_date',id=$new_receipt_number,pay_mode=$pay_mode,cn='' where id=$receipt_number";
                                        } else {
                                            $sql = "UPDATE  dafan_receipt set amt='$amt',status=$receipt_status,date='$receipt_date',id=$new_receipt_number,pay_mode=$pay_mode,cn='$cn' where id=$receipt_number";
                                        }
                                    }
                                    if (mysqli_query($conn, $sql)) {
                                        $log = "EDITTED RECEIPT FOR RECEIPT ID " . $receipt_type . "/" . $receipt_number;
                                ...
                                ?>
                                        ...
                                        ?>
                                            <script type="text/javascript">
                                                window.open('receipt_add_view.php?id=<?php echo $new_receipt_number ?>&entry_type=new', '_blank');
                                            </script>
                                        <?php
                                        } else {
                                        ?>
                                            <script type="text/javascript">
                                                window.open('receipt_add_view.php?id=<?php echo $new_receipt_number ?>&entry_type=old', '_blank');
                                            </script>
                                        <?php
                                        }
                                        ?>
                                ...
                                if (isset($_GET['submit'])) {
                                    ...
                                    if ($receipt_type == "NW") {
                                        ...
                                        $sql = "SELECT dafan_id,harwai_id,type,amt,pay_mode,cn FROM dafan_receipt_1 where id=$receipt_number";
                                    } else {

                                        $sql = "SELECT dafan_id,harwai_id,type,amt,pay_mode,cn FROM dafan_receipt where id=$receipt_number";
                                    }
                                    $run = $conn->query($sql);
                                    if ($run->num_rows > 0) {
                                        $row = $run->fetch_assoc();
                                ...
                                ?>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    if ($receipt_type == "NW") {
                                                        $sql = "SELECT id,date,status,amt,dafan_id,harwai_id,type,pay_mode,cn from dafan_receipt_1 WHERE id=$receipt_id";
                                                        $entry_type = "new";
                                                    } else {
                                                        $sql = "SELECT id,date,status,amt,dafan_id,harwai_id,type,pay_mode,cn from dafan_receipt WHERE id=$receipt_id";
                                                        $entry_type = "old";
                                                    }
                                                    ...
                                                    <form method="POST">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                ...
                                                                if ($receipt_type == "NW") {
                                                                ?>
                                                                    <input type="number" name="receipt_no" value="<?php echo $receipt_number ?>" placeholder="Enter Receipt Number" class="form-control" readonly required />

                                                                <?php
                                                                } else {
                                                                ?>
                                                                    <input type="number" name="receipt_no" value="<?php echo $receipt_number ?>" placeholder="Enter Receipt Number" class="form-control" onfocus="this.removeAttribute('readonly');" required />
                                                                <?php
                                                                }
                                                                ?>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                ...
                                                                <input type="number" name="amt" value="<?php echo $amt ?>" placeholder="Enter Amount" class="form-control" onfocus="this.removeAttribute('readonly');" required />
                                                        ...
                                                        <div id="cheque">
                                                            ...
                                                            ?>
                                                                ...
                                                                <div class="form-group row"><label class="col-sm-2 col-form-label">Cheque No.</label>
                                                                    <div class="col-sm-10"><input class="form-control" type="text" name="cn" placeholder="Enter Cheque No." value="<?php echo $cn ?>" required /></div>
                                                                </div>
                                                            <?php
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" value="<?php echo $receipt_date ?>" name="receipt_date" placeholder="Select Receipt Date" autocomplete="FALSE" class="form-control datepicker" id="datepicker" required>
                                                        ...
                                                        ?>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <select class="form-control" name="receipt_status" required>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                ...
                                                                <button class="btn btn-mat waves-effect waves-light btn-primary" value="<?php echo $receipt_number ?>" name="submit1">Submit</button>
    ...
    <script>
        function change_mode_receipt() {
            ...
            if (type == "1") {
                document.getElementById("cheque").innerHTML = ' <div class="form-group row"><label class="col-sm-2 col-form-label">Cheque No.</label><div class="col-sm-10"><input class="form-control" type="text" name="cn" placeholder="Enter Cheque No." value="<?php echo $cn ?>" required/></div></div>';
